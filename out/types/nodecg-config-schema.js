...
exports.nodecgConfigSchema = zod_1.z
    ...
    bundles: zod_1.z
        ...
        enabled: zod_1.z
            ...
            .nullable()
            .default((_a = parsedArgv.bundlesEnabled) !== null && _a !== void 0 ? _a : null)
            .describe("A whitelist array of bundle names."),
        disabled: zod_1.z
            .array(zod_1.z.string())
            .nullable()
            .default((_b = parsedArgv.bundlesDisabled) !== null && _b !== void 0 ? _b : null)
            .describe("A blacklist array of bundle names."),
        paths: zod_1.z
            .array(zod_1.z.string())
            .default((_c = parsedArgv.bundlesPaths) !== null && _c !== void 0 ? _c : [])
    ...
    login: zod_1.z
        ...
        steam: zod_1.z
            ...
            .optional()
            .refine((val) => ((val === null || val === void 0 ? void 0 : val.enabled) ? typeof val.apiKey === "string" : true), {
        ...
        twitch: zod_1.z
            ...
            .optional()
            .refine((val) => ((val === null || val === void 0 ? void 0 : val.enabled) ? typeof val.clientID === "string" : true), {
            message: '"login.twitch.clientID" must be a string',
        })
            .refine((val) => (val === null || val === void 0 ? void 0 : val.enabled) ? typeof val.clientSecret === "string" : true, {
            message: '"login.twitch.clientID" must be a string',
        }),
        discord: zod_1.z
            .object({
    ...
    return Object.assign(Object.assign({}, val), { baseURL: (_a = val.baseURL) !== null && _a !== void 0 ? _a : `${host}:${val.port}` });
});
