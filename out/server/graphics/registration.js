...
const BUILD_PATH = path_1.default.join(nodecg_path_1.nodecgPath, "dist/instance");
class RegistrationCoordinator {
    constructor(io, bundleManager, replicator) {
        ...
        this._instancesRep = replicator.declare("graphics:instances", "nodecg", {
            schemaPath: path_1.default.resolve(nodecg_path_1.nodecgPath, "schemas/graphics%3Ainstances.json"),
            persistent: false,
            defaultValue: [],
        });
