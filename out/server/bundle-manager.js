    ...
    constructor(bundlesPaths, cfgPath, nodecgVersion, nodecgConfig) {
        ...
        bundlesPaths.forEach((bundlesPath) => {
            ...
            const handleBundle = (bundlePath) => {
                ...
                if ((_b = (_a = nodecgConfig === null || nodecgConfig === void 0 ? void 0 : nodecgConfig["bundles"]) === null || _a === void 0 ? void 0 : _a.disabled) === null || _b === void 0 ? void 0 : _b.includes(bundleName)) {
                ...
                if (((_c = nodecgConfig === null || nodecgConfig === void 0 ? void 0 : nodecgConfig["bundles"]) === null || _c === void 0 ? void 0 : _c.enabled) &&
                    !(nodecgConfig === null || nodecgConfig === void 0 ? void 0 : nodecgConfig["bundles"].enabled.includes(bundleName))) {
            ...
            if (!project_type_1.isLegacyProject) {
                handleBundle(root_path_1.rootPath);
            }
