...
exports.dataSource = new typeorm_1.DataSource({
    ...
    database: testing
        ? ":memory:"
        : node_path_1.default.join((0, nodecg_root_1.getNodecgRoot)(), "db/nodecg.sqlite3"),
    logging: false,
    entities: [entity_1.ApiKey, entity_1.Identity, entity_1.Permission, entity_1.Replicant, entity_1.Role, entity_1.User],
    migrations: [
        node_path_1.default.join(nodecg_path_1.nodecgPath, "out/server/database/default/migration/*.js"),
    ],
    migrationsRun: true,
    synchronize: false,
});
