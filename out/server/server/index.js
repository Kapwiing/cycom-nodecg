...
class NodeCGServer extends typed_emitter_1.TypedEmitter {
    ...
    start() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const bundlesPaths = [path.join((0, nodecg_root_1.getNodecgRoot)(), "bundles")].concat((_b = (_a = config_1.config.bundles) === null || _a === void 0 ? void 0 : _a.paths) !== null && _b !== void 0 ? _b : []);
            const cfgPath = path.join((0, nodecg_root_1.getNodecgRoot)(), "cfg");
            ...
            bundleManager.all().forEach((bundle) => {
                ...
                if (bundle.transformBareModuleSpecifiers) {
                    ...
                    const opts = {
                        rootDir: (0, nodecg_root_1.getNodecgRoot)(),
            ...
            const bundlesReplicant = replicator.declare("bundles", "nodecg", {
                schemaPath: path.resolve(nodecg_path_1.nodecgPath, "schemas/bundles.json"),
                persistent: false,
            });
