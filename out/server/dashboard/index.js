...
const BUILD_PATH = path.join(nodecg_path_1.nodecgPath, "dist");
class DashboardLib {
    constructor(bundleManager) {
        ...
        app.use("/node_modules/:filePath(.*)", (req, res, next) => {
            const rootNodeModulesPath = path.join(root_path_1.rootPath, "node_modules");
            const basePath = nodecg_path_1.nodecgPath;
