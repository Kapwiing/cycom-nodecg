...
const getAssetsPath = () => node_path_1.default.join((0, nodecg_root_1.getNodecgRoot)(), "assets");
...
const createAssetsMiddleware = (bundles, replicator) => {
    ...
    for (const collection of collections) {
        ...
        for (const category of collection.categories) {
            ...
            if (category.allowedTypes && category.allowedTypes.length > 0) {
                watchDirs.push({
                    path: categoryPath,
                    types: (_a = category.allowedTypes) !== null && _a !== void 0 ? _a : [],
                });
            }
            else {
                watchDirs.push({
    ...
    const fixedPaths = Array.from(watchDirs).map((pattern) => (Object.assign(Object.assign({}, pattern), { path: pattern.path.replace(/\\/g, "/") })));
